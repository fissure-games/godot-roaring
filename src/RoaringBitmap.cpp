...
void RoaringBitmap::_bind_methods()
{
    ...
    godot::ClassDB::bind_method( godot::D_METHOD( "get_cardinality" ),
                                 &RoaringBitmap::get_cardinality );
    ...
    godot::ClassDB::bind_method( godot::D_METHOD( "intersection_of", "other" ),
                                 &RoaringBitmap::intersection_of );
    godot::ClassDB::bind_method( godot::D_METHOD( "union_of", "other" ), &RoaringBitmap::union_of );
    godot::ClassDB::bind_method( godot::D_METHOD( "difference_of", "other" ),
                                 &RoaringBitmap::difference_of );
    godot::ClassDB::bind_method( godot::D_METHOD( "symmetric_union", "other" ),
                                 &RoaringBitmap::symmetric_union );
